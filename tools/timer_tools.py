...
def set_timer(duration_minutes: int, theme: str, room_name: str) -> str:
    ...
    try:
        ...
        # バックグラウンドでタイマーを開始
        timer.start()
        return f"Success: A timer has been set for {duration_minutes} minutes with the theme '{theme}'. You will be notified by {room_name}. **この設定タスクは完了しました。**設定が完了したことだけを簡潔にユーザーに報告してください。"
