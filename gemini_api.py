...
# ★★★ 修正点1：mem0_manager と character_manager、utils をインポートする ★★★
import mem0_manager
import utils
...
def invoke_nexus_agent(*args: Any) -> str:
    ...
    # ★★★ 修正点2：過去の会話履歴を、全て、エージェントに、渡すように、戻す ★★★
    messages = []
    ...
    # UIの設定（履歴件数制限）は、ここでは適用せず、生の、全履歴を、一度、全て、渡す
    ...
    initial_state = {
        "messages": messages, # ← 全ての履歴が入ったリスト
