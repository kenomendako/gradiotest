...
LOGGING_CONFIG = {
    ...
    "loggers": { "memos": { "level": "WARNING", "propagate": True }, "gradio": { "level": "WARNING", "propagate": True }, "httpx": { "level": "WARNING", "propagate": True }, "neo4j": { "level": "WARNING", "propagate": True }, },
}
try:
            ...
            while i < len(conversation_pairs):
                ...
                while attempt < max_retries and not success:
                    try:
                        await cognee.add(
                            dialogue = pair,
                            dialogue_metadata = { "source_file": filename, "pair_index": i, "character": character_name, }
                        )
                        success = True
