...
- [ ] **書き置き機能（自律行動向けメッセージ）** 🆕 (2025-12-25 INBOXより)
  - 即時送信ではなく、自律行動時にAIペルソナにメッセージを渡す機能
  - 用途: 今何をしている・どこにいる等をペルソナに伝える
  - 簡易版: notepad.md を活用
  - フル版: 専用UI、既読管理、キュー管理
...
- [ ] **会話ログ編集欄の新設** 🆕 (2025-12-25 INBOXより)
  - チャット欄とタブ切り替え、または上部タブメニューに新設
