...
| 2026-01-28 | **Zhipu AI ツール実行不具合の修正**<br>・ツール実行時にプロバイダ設定が無視される問題を解消 (Pass room_name)<br>・Zhipu AIでの自律ファイル編集動作を安定化 | [レポート](reports/2026-01-28_Zhipu_Tool_Provider_Fix.md) |
