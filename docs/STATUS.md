...
| 2026-01-29 | **APIキーローテーションの1周制限の実装**<br>・利用可能な全キーを試行した後はリトライを停止し、無限ループを防止<br>・チャット応答およびRAG索引更新の両方に適用<br>・全キー枯渇時の即時エラー通知により、ユーザーが状況を把握可能に | [レポート](reports/2026-01-29_api_key_rotation_limit.md) |
