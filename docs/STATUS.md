...
> 最終更新: 2026-01-13 (Linuxデスクトップ通知エラー修正)
...
| 日付 | タスク | レポート |
|------|--------|----------|
| 2026-01-13 | **Linuxデスクトップ通知エラー修正**<br>・plyerがdbus/notify-sendを見つけられない問題を解消<br>・Linux環境ではデスクトップ通知を無効化 | [レポート](reports/2026-01-13_linux_notification_fix.md) |
