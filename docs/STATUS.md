...
- [x] **ユーザー添付画像リサイズ（APIコスト削減）** ✅ (2025-12-31 完了)
  - ✅ 共通ユーティリティ`utils.resize_image_for_api()`をPIL Image対応に拡張
  - ✅ API送信前に768pxにリサイズ（元形式維持）
...
| 日付 | タスク | レポート |
|------|--------|----------|
| 2026-01-01 | エンティティ記憶UI統合、話題クラスタ廃止、起動エラー(NameError)修正 | - |
